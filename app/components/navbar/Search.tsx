...
const Search = () => {
  return (
    <div className="border-[1px] border-neutral-300  w-full md:w-auto py-1 rounded-full shadow-sm hover:shadow-md cursor-pointer transition">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="text-sm pl-6 pr-2 text-gray-600 flex flex-row items-center gap-3">
          ...
          <div className="p-[10px] bg-rose-500 rounded-full text-white m-[7px] ml-0">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
